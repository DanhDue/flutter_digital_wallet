...
mixin _$AppThemesTailorMixin on ThemeExtension<AppThemes> {
  ...
  AppThemes lerp(covariant ThemeExtension<AppThemes>? other, double t) {
    ...
    return AppThemes(
      ...
      blue15: Color.lerp(blue15, other.blue15, t)!,
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality().equals(zenoSurface, other.zenoSurface) &&
            const DeepCollectionEquality().equals(zenoBorder, other.zenoBorder) &&
            const DeepCollectionEquality().equals(zenoText, other.zenoText) &&
            const DeepCollectionEquality().equals(zenoTextMuted, other.zenoTextMuted) &&
            const DeepCollectionEquality().equals(zenoSuccess, other.zenoSuccess) &&
            const DeepCollectionEquality().equals(zenoAccent, other.zenoAccent) &&
            ...
            const DeepCollectionEquality().equals(blue15, other.blue15) &&
            const DeepCollectionEquality().equals(blue20, other.blue20) &&
            const DeepCollectionEquality().equals(blue40, other.blue40) &&
  ...
  int get hashCode {
    return Object.hashAll([
      ...
      const DeepCollectionEquality().hash(blue15),
      const DeepCollectionEquality().hash(blue20),
      const DeepCollectionEquality().hash(blue40),
...
extension AppThemesBuildContext on BuildContext {
  AppThemes get appThemes => Theme.of(this).extension<AppThemes>()!;
}
